...
class _CallScreenState extends ConsumerState<CallScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_isCallInitialized) {
      ...
      callVM.initCall(
        AgoragConfig.appId,
        widget.channelId,
        widget.call.receiverId.hashCode,
        relay: widget.ipProtectionEnabled,
      ).then((_) {
        if (widget.cameraEffectsEnabled) {
  ...
  Widget build(BuildContext context) {
    ...
    if (callState.status == CallStatus.loading || callState.status == CallStatus.initial) {
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () async {
                      await callController.leaveCall(widget.call.callerId, widget.call.receiverId, context);
