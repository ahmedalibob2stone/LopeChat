// lib/features/privacy/domain/usecases/advanced/set_protect_ip_in_calls_usecase.dart
...
final setProtectIpInCallsUseCaseProvider = Provider<SetProtectIpInCallsUseCase>((ref) {
  return SetProtectIpInCallsUseCase(
