// lib/features/privacy/domain/usecases/advanced/get_protect_ip_in_calls_usecase.dart
...
final getProtectIpInCallsUseCaseProvider = Provider<GetProtectIpInCallsUseCase>((ref) {
  return GetProtectIpInCallsUseCase(
