...
final setBlockUnknownSendersUseCaseProvider =
Provider<SetBlockUnknownSendersUseCase>((ref) {
  final repository = ref.read(advancedPrivacyRepositoryProvider);
  final auth = ref.read(firebaseAuthProvider);
  return SetBlockUnknownSendersUseCase(repository: repository, firebaseAuth: auth);
});