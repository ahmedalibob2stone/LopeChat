...
import '../../../../../domain/usecases/privacy/block/unblock_privacy_usecase.dart';
...
final unblockPrivacyUserUseCaseProvider = Provider<UnblockPrivacyUserUseCase>((ref) {
  final repository = ref.watch(blockPrivacyRepositoryProvider);
  final auth = ref.watch(firebaseAuthProvider);
  return UnblockPrivacyUserUseCase(repository, auth);
});
