...
// مزود SetStatusPrivacyUseCase
final setStatusPrivacyUseCaseProvider = Provider<SetStatusPrivacyUseCase>((ref) {
  final repository = ref.watch(statusPrivacyRepositoryProvider);
  final auth = ref.watch(firebaseAuthProvider);
  return SetStatusPrivacyUseCase(repository: repository, auth: auth);
});